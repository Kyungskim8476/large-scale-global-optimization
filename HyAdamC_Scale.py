...
class HyAdamC_Scale(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, k_dof=1.0, betas=(0.9, 0.999), eps=1e-8, gamma=1.0):
        ...
        super(HyAdamC_Scale, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(HyAdamC_Scale, self).__setstate__(state)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                # Short-term velocity control function (Scale version)
